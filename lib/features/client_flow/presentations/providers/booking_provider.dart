...
// 2️⃣ Form + UI State Service
// (controllers, obscure, checkbox, validation, dispose)

// dart
// Copy code

// 3️⃣ Certificate & Professional Details Service
// dart
// Copy code

// 4️⃣ Document & Image Upload Service
// (all upload / remove logic)

// dart
// Copy code
// class InspectorDocumentService {
//   final InspectorViewModelProvider vm;
//   InspectorDocumentService(this.vm);
...
//     final res = await vm.executeParamsUseCase<
//         UploadImageResponseModel,
//         UploadImageParams>(
//       useCase: uploadUseCase,
//       query: UploadImageParams(filePath: UploadImageDto(filePath: file.path)),
//       launchLoader: true,
//     );
...
//   }
// }
// 5️⃣ Location + Country/State/City Service
// dart
// Copy code
// class InspectorLocationService {
//   final InspectorViewModelProvider vm;
//   InspectorLocationService(this.vm);

//   List<csc.Country>? countries;
//   Map<String, List<csc.State>> states = {};
//   Map<String, List<csc.City>> cities = {};
...
//   Future<void> loadStates(String code) async {
//     states[code] ??= await csc.getStatesOfCountry(code);
//     vm.notifyListeners();
//   }

//   Future<void> loadCities(String code) async {
//     cities[code] ??= await csc.getCountryCities(code);
//     vm.notifyListeners();
//   }
// }
// 6️⃣ Service Area Logic
// dart
// Copy code
// class InspectorServiceAreaService {
//   final InspectorViewModelProvider vm;
//   InspectorServiceAreaService(this.vm);
...
//     for (final name in selectedCities) {
//       final city = allCities.firstWhere((c) => c.name == name);
//       serviceAreas.add(
...
//   }
// }
// 7️⃣ Persistence (Local Save / Load)
// dart
// Copy code
// class InspectorPersistenceService {
//   final InspectorViewModelProvider vm;
//   final _localDs = locator<InspectorSignUpLocalDataSource>();

//   InspectorPersistenceService(this.vm);

//   Future<void> savePersonalStep() async {
//     await _localDs.updateFields({
//       'name': vm.formService.fullNameCtrl.text,
//       'email': vm.formService.emailCtrlSignUp.text,
//       'password': vm.formService.passwordCtrlSignUp.text,
//     });
//   }

//   Future<InspectorSignUpLocalEntity?> loadSavedData() =>
//       _localDs.getFullData();
// }
// 8️⃣ Steps + Validation + Auth
// dart
// Copy code
// class InspectorStepService {
//   final InspectorViewModelProvider vm;
//   InspectorStepService(this.vm);
...
// dart
// Copy code
// class InspectorAuthService {
//   final InspectorViewModelProvider vm;
//   InspectorAuthService(this.vm);

//   Future<void> signUp(BuildContext context) async {
//     vm.setProcessing(true);
//     final saved =
//         await locator<InspectorSignUpLocalDataSource>().getFullData();

//     final useCase = locator<InspectorSignUpUseCase>();
//     await vm.executeParamsUseCase<AuthUser, InspectorSignUpParams>(
//       useCase: useCase,
//       query: InspectorSignUpParams(inspectorSignUpLocalEntity: saved!),
//       launchLoader: true,
//     );
