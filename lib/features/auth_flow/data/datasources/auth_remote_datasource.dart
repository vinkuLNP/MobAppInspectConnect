...
import 'package:clean_architecture/core/utils/helpers/http_strategy_helper/concrete_strategies/post_request_strategy.dart';
import 'package:clean_architecture/core/utils/helpers/http_strategy_helper/http_request_context.dart';
import 'package:clean_architecture/features/auth_flow/data/models/auth_user_dto.dart';
import 'package:clean_architecture/features/auth_flow/data/models/resend_otp_request_model.dart';
import 'package:clean_architecture/features/auth_flow/data/models/signin_request_model.dart';
import 'package:clean_architecture/features/auth_flow/data/models/signup_request_model.dart';
import 'package:clean_architecture/features/auth_flow/data/models/verify_otp_request_model.dart';
    ...
    return res.when(
      success: (http.Response response) {
        ...
        final Map<String, dynamic> body =
            (root['body'] as Map?)?.cast<String, dynamic>() ?? <String, dynamic>{};
